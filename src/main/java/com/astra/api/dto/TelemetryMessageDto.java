...
public class TelemetryMessageDto {
    ...
    public Boolean getTamperFlag() { return tamperFlag; }
    public void setTamperFlag(Boolean tamperFlag) { this.tamperFlag = tamperFlag; }

    public Long getTimestampEpochMillis() { return timestampEpochMillis; }
    public void setTimestampEpochMillis(Long timestampEpochMillis) { this.timestampEpochMillis = timestampEpochMillis; }
}
